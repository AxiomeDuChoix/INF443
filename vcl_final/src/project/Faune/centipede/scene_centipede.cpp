...
void scene_project::display_terrain(std::map<std::string,GLuint>& shaders, scene_structure& scene)
{
...
void scene_project::display_tree(std::map<std::string,GLuint>& shaders, scene_structure& scene)
{
    if(!gui_scene.tree)
        return ;
...
void scene_project::display_mushroom(std::map<std::string,GLuint>& shaders, scene_structure& scene)
{
...
void scene_project::display_grass(std::map<std::string,GLuint>& shaders, scene_structure& scene)
{
    if(!gui_scene.grass)
        return;
...
void scene_project::display_flower(std::map<std::string,GLuint>& shaders, scene_structure& scene)
{
    if(!gui_scene.flower)
        return ;
...
void scene_project::display_centipede(std::map<std::string,GLuint>& shaders, scene_structure& scene)
{
...
void scene_project::display_trajectory(std::map<std::string,GLuint>& shaders, scene_structure& scene)
{
...
void scene_project::update_mushroom_position()
{
...
vcl::mesh scene_project::create_billboard_surface()
{
    mesh billboard;
...
void scene_project::update_flower_position()
{
...
void scene_project::update_trajectory()
{
    const size_t N = 12;
    const float r = 3.0f;
    for(size_t k=0; k<N; ++k)
...
//    trajectory.position.push_back(trajectory.position.back());
//    trajectory.position.push_back(trajectory.position.back());
    update_time_trajectory();

}

void scene_project::update_time_trajectory()
{
...
void scene_project::mouse_click(scene_structure& scene, GLFWwindow* window, int , int action, int )
{
